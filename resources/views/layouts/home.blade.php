...
<html>
    ...
    <body>
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">School  <span>Damenge</span></a>
        ...
        <main>
            <div class="parallax">
                <div class="caption">
                    <span class="border">DAMENGE <span style="color:#30a5ff;">SCHOOL</span></span>
                    <br>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav nav-pills nav-justified">
                            <li><a href="/">© 2020 johannnasendi</a></li>
                        </ul>
                    </div>
                </div>
            </div>
